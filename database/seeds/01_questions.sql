...
('An angry dragon is blocking your path. Who in the party would you send to negotiate a peaceful solution?', 'peer-assessment', '{}', 'CHA'),
('You''re about to enter a complex dungeon filled with traps. Who do you ask to map out the safest route?', 'peer-assessment', '{}', 'INT'),
('Who in the party would you bet on to win a no-holds-barred arm-wrestling tournament?', 'peer-assessment', '{}', 'STR'),
...
('Who is the most likely to say "I''ve got a bad feeling about this," and then do it anyway?', 'peer-assessment', '{}', 'WIS'),
...
('Who in the party could calm down an angry owlbear just by talking to it?', 'peer-assessment', '{}', 'CHA'),
('When faced with a morally ambiguous choice, who does the party look to for guidance?', 'peer-assessment', '{}', 'WIS'),
...
('The party''s wagon has a broken wheel. Who is most likely to rig up a clever, unconventional solution to get it moving again?', 'peer-assessment', '{}', 'INT'),
