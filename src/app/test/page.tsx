          ...
          <div className="fantasy-card ornate-border p-8 mb-8 max-w-2xl mx-auto magical-glow">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-4">
              <input
                ...
                className="fantasy-input max-w-md text-center placeholder:text-amber-600 px-4 py-2"
              />
          ...
          <div className="fantasy-card ornate-border p-8 mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <input
                ...
                className="fantasy-input max-w-xs text-center placeholder:text-amber-600 px-4 py-2"
              />
